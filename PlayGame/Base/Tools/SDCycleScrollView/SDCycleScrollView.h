...
/** 点击图片回调 */
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView view:(UIImageView *)imgView didSelectItemAtIndex:(NSInteger)index;
...
/* 是否展示addam广告，默认位no**/
@property (nonatomic, assign) BOOL addMoreItem;
